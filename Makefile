...
FILES = build/main.o build/Utaste.o build/User.o build/Restaurant.o build/Reservation.o build/Discount.o build/Terminal.o
EXE = UTaste
...
build/Restaurant.o: src/Restaurant.cpp src/Restaurant.hpp src/district.hpp src/Reservation.hpp src/Discount.hpp
	$(CXX) -c $< -o $@

build/Reservation.o: src/Reservation.cpp src/Reservation.hpp src/User.hpp src/Exceptions.hpp
	$(CXX) -c $< -o $@

build/Discount.o: src/Discount.cpp src/Discount.hpp src/Reservation.hpp src/Exceptions.hpp src/libraries.hpp 
	$(CXX) -c $< -o $@
